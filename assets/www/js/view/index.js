...
if (!localStorage.getItem("firstname")) {
	...
	// 0        1                 2                  3                  4								5
  // Name(s), energy_impact(i), fitness_impact(i), image_location(s), description(s), quantity(i)  
	item0 = ["Apple", 10, 2, "apple.gif", 'A healthy treat for your pet!', 0];
  item1 = ["Ice-cream", 4, -1, "icecream.gif", 'Perhaps... something sweet?', 0];
  item2 = ["Hamburger", 37, -8, "burger.gif", 'Oh boy, that looks tasty. Squarish and all!', 0];
  item3 = ["Sushi", 30, 4, "sushi.gif", 'Delicacies of the sea!', 0];
  item4 = ["Happy Meal", 72, -12, "happymeal.gif", 'Sinning is fine, just don\'t overdo it~', 0];
  item5 = ["Dumbbells",-38, 18, "dumbbells.gif", 0];
